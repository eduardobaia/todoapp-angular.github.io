...
module.exports = "<div class=\"container\">\n  <!--  div.row to bootstrap -->\n  <div class=\"row\">\n    <!--  div.col-md-6.offset-md-3 the center contains 6 cols, and both sides 3 -->>\n    <div class=\"col-md-6 offset-md-3\">\n      <app-todo></app-todo>\n\n    </div>\n\n  </div>\n</div>\n\n<router-outlet></router-outlet>"
...
var TodoService = /** @class */ (function () {
    ...
    TodoService.prototype.getTodoList = function () {
        //initialize the todo list and get from db titles
        this.toDoList = this.firebasedb.list('titles');
        return this.toDoList;
    };
    //to add the list at firebase
    ...
    //ccheck or uncheck title method
...
var TodoComponent = /** @class */ (function () {
    ...
    TodoComponent.prototype.ngOnInit = function () {
        ...
        this.toDoService.getTodoList().snapshotChanges()
            //<!-- patameter item, initialize the arrayList 
            //inside Item parameter we have a collection from firebase db
            // element.payload.toJSON retunr a element of the type that is in todo.service.  (add title) -->
...
var environment = {
    production: true,
    firebase: {
        apiKey: "AIzaSyB5fxbpKMZECWLQvd31jBUUU9bU7HvwvHg",
        authDomain: "todolistapp-45f44.firebaseapp.com",
        databaseURL: "https://todolistapp-45f44.firebaseio.com",
        projectId: "todolistapp-45f44",
        storageBucket: "todolistapp-45f44.appspot.com",
        messagingSenderId: "1055140946307"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\eduar\Documents\Angular Projects\firsttodoapp\src\main.ts */"./src/main.ts");
